...
<head>
    ...
    <link href="theme/base/nova_assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.3" rel="stylesheet"
        type="text/css" />
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="theme/base/nova_assets/plugins/global/plugins.bundle.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="theme/base/nova_assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="theme/base/nova_assets/css/style.bundle.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="theme/base/nova_assets/css/custom.css" rel="stylesheet" type="text/css" />

    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="theme/base/nova_assets/css/themes/layout/header/base/light.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="theme/base/nova_assets/css/themes/layout/header/menu/light.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="theme/base/nova_assets/css/themes/layout/brand/dark.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="theme/base/nova_assets/css/themes/layout/aside/dark.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->
    <!-- begin:: dàn cấm xoá -->
    <style type="text/css">
        body {
...
<body id="kt_body"
        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:theme/base/nova_assets/media/svg/icons/General/User.svg-->
                ...
                <div class="brand flex-column-auto" id="kt_brand" kt-hidden-height="65">
                    ...
                    <button class="brand-toggle btn btn-sm px-0" id="kt_aside_toggle">
                        <span class="svg-icon svg-icon svg-icon-xl">
                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo1/dist/theme/base/nova_assets/media/svg/icons/Navigation/Angle-double-left.svg--><svg
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                <div class="d-flex align-items-baseline mr-5">
                                    <h5 id="sub_title_h5" class="text-dark font-weight-bold my-2 mr-5">
                                        @yield('title')</h5>
                                </div>
                            </div>
                        </div>
    ...
    <script src="theme/base/nova_assets/plugins/global/plugins.bundle.js?v=7.0.3"></script>
    <script src="theme/base/nova_assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.3"></script>
    <script src="theme/base/nova_assets/js/scripts.bundle.js?v=7.0.3"></script>
    <!--end::Global Theme Bundle-->
    <!--begin::Page Vendors(used by this page)-->
    <script src="theme/base/nova_assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.3"></script>
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="theme/base/nova_assets/js/pages/widgets.js?v=7.0.3"></script>
    <script src="/theme/base/nova_assets/js/pages/features/miscellaneous/blockui.js?v=7.0.3"></script>
    <iframe id="_hjSafeContext_94917652" title="_hjSafeContext" tabindex="-1" aria-hidden="true" src="about:blank"
        style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe>
    <!-- <script src="theme/base/nova_assets/js/pages/crud/ktdatatable/base/data-local.js"></script> -->
    <script src="theme/base/js/utils.js"></script>
    <!--end::Page Scripts-->
    <script src="theme/base/nova_assets/js/pages/crud/forms/widgets/select2.js?v=7.0.3"></script>
