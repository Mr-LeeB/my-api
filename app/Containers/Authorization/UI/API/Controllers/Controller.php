...
use App\Containers\Authorization\UI\API\Requests\AssignUserToPermissionRequest;
...
use App\Containers\Authorization\UI\API\Requests\RevokeUserFromPermissionRequest;
...
class Controller extends ApiController
{
  ...
  /**
   * @param \App\Containers\Authorization\UI\API\Requests\AssignUserToPermissionRequest $request
   *
   * @return  mixed
   */
  ...
  /**
   * @param \App\Containers\Authorization\UI\API\Requests\RevokeUserFromPermissionRequest $request
   *
   * @return  mixed
   */
  public function revokePermisstionFromUser(RevokeUserFromPermissionRequest $request)
  {
    $user = Apiato::call('Authorization@RevokeUserFromPermissionAction', [new DataTransporter($request)]);
